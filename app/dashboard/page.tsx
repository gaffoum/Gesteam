...
import { 
  Users, Calendar as CalendarIcon, Loader2, Trophy, Activity, 
  Shield, ArrowRight, BookOpen, Plus, UserPlus
} from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (!session) return; // La redirection est gérée par le middleware ou le layout si besoin
  ...
  // Helper pour l'icône selon l'action (pour les logs)
  ...
  return (
    <div className="p-6 md:p-12 font-sans text-[#1a1a1a]">
