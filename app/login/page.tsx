...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-6 italic overflow-hidden bg-black">
      ...
      >
        {/* Overlay sombre (80%) pour l'élégance et la lisibilité */}
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-[#1a1a1a]/90 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-[#ff9d00] text-[9px] font-bold uppercase tracking-[0.3em] mt-2 italic">Connexion Coach</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {errorMsg && (
              <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-black uppercase rounded-2xl flex items-center gap-2">
            ...
            <button type="submit" disabled={loading} className="w-full bg-[#ff9d00] text-[#1a1a1a] font-black uppercase py-5 rounded-2xl flex items-center justify-center gap-2 hover:bg-[#ffb338] transition-all shadow-xl shadow-[#ff9d00]/20">
